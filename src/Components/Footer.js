...
function Footer() {
  return (
    ...
    <div class='container-lg'><footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
      ...
      <p class="text" id='copyright'>Copyright 2022 <span id='coupling'>Coupling </span>LLC. All Rights Reserved Created By <span className='footerscolor'>Tolgahan Bora</span ></p></div>
  )
}
